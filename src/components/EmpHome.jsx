  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const userRequest = axios.get(`http://192.168.1.188/hrwebapi/api/Users/Getbyid/${id}`);
        const documentsRequest = axios.get('http://192.168.1.188/hrwebapi/api/Files/Document', {
          params: { userID: id }
        });
        const educationsRequest = axios.get(`http://192.168.1.188/hrwebapi/api/Educations/Getbyid/${id}`);
        const experiencesRequest = axios.get(`http://192.168.1.188/hrwebapi/api/WorkExperiences/Getbyid/${id}`);
