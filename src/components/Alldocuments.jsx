    ...
    const fetchData = async () => {
        try {
            ...
            const [eduResponse, expResponse] = await Promise.all([
                axios.get(`http://192.168.1.188/hrwebapi/api/Admin/educations/user/${user.userID}`),
                axios.get(`http://192.168.1.188/hrwebapi/api/Admin/WorkExperiences/user/${user.userID}`)
            ]);
