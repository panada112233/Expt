...
const EditEducation = () => {
  ...
  useEffect(() => {
    const fetchEducation = async () => {
      try {
        const response = await axios.get(`https://192.168.1.188/hrwebapi/api/Admin/educations/${id}`);
  ...
  const handleSave = async (e) => {
    ...
    try {
      await axios.put(`https://192.168.1.188/hrwebapi/api/Admin/educations/${id}`, education);
