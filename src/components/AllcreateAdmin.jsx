    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-black font-FontNoto text-center">เพิ่มผู้ใช้งานในระบบ</h2>
                {loading && <p style={{ textAlign: 'center', color: '#6B7280' }}>กำลังโหลดข้อมูล...</p>}
                {error && <p style={{ textAlign: 'center', color: '#DC2626' }}>{error}</p>}
                <form onSubmit={handleSubmit}>
                    <div className="form-control mb-4 font-FontNoto">
                        ข้อมูลส่วนตัว
